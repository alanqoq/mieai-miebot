...
## Corpus Check
- 35 files · ~12,621 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 499 nodes · 708 edges · 37 communities (31 shown, 6 thin omitted)
...
2. `OpenAiChatProvider` - 15 edges
3. `MieAiEngine` - 14 edges
4. `required` - 14 edges
...
Cohesion: 0.10
Nodes (11): EventSubscription, PluginEvent, BotPlugin, MieAiBotPlugin, BotPlugin, BotPluginFactory, PluginRuntimeContext, MieAiBotPluginFactory (+3 more)
...
Cohesion: 0.15
Nodes (9): java, DeliveryTracker, ChatTaskStatus, CANCELLED, COMPLETED, FAILED, PENDING, RUNNING (+1 more)
